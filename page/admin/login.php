...
<body style="font-family: 'Prompt', sans-serif;">
    <div class="d-flex flex-column justify-content-evenly align-items-center" style="height: 100vh;">
        <div class="d-flex flex-column justify-content-center align-items-center rounded-3 p-5" style=" background-image: linear-gradient(0deg, rgba(0, 224, 45, 1) 0%, rgba(0, 112, 99, 1) 80%); width:28vw; height:60vh; position:relative;">
            <a href="../../index.php">
                <i class="fa-solid fa-arrow-left" style="position:absolute; top:30px; left:30px; font-size:24px; color:#ffff; "></i>
            </a>
            <i class="fa-solid fa-database my-3  " style="font-size: 5rem; color:#ffff;"></i>
            <p class="fw-bold mb-3" style="font-size:40px; color:#ffff;">เข้าสู่ระบบแอดมิน</p>
            <!-- <form action="<?php //echo htmlentities($_SERVER['PHP_SELF'])
                                ?>" id="LoginFrom" method="POST" class="d-flex flex-column justify-content-center align-items-center w-75"> -->
            <form action="./method/loginAdminDB.php" id="LoginFrom" method="POST" class="d-flex flex-column justify-content-center align-items-center w-75">
                <div class=" w-100">
