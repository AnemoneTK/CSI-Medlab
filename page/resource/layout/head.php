...
<head>
    ...
    <link rel="stylesheet" href="../resource/css/select2-bootstrap4.min.css">
    ...
    <script src="../resource/js/select2.full.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>

    <!-- table  -->
    <link rel="stylesheet" href="../resource/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="../resource/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="../resource/css/buttons.bootstrap4.min.css">
    ...
    <script src="../resource/js/responsive.bootstrap4.min.js"></script>
